...
// export default async function loadCache(cacheKeys) {
//   // if (!cacheKeys) {
//   //   console.log('service cache keys', cacheKeys);
//   //   throw new Error('parameter cacheKeys is invalid');
//   // }
//   const result = await CacheService.laodMultCache(cacheKeys);
//   return result;
// }
